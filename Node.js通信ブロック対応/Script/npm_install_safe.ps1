# =====================================================================================
# 一時的に送信通信をブロック解除し、npm install を実行後、送信通信を再度ブロックするスクリプト
# 必ず管理者権限で実行してください。
# =====================================================================================
...
# ここに、必要な npm install コマンドを記述します。
# npm -v とは、Node.js のバージョンを確認するためのコマンドです。
# 実際は、npm install <package-name> のように、必要なパッケージを記述して実行します。
# 例: npm install <package-name>
npm -v
